...
if __name__ == '__main__':
    ...
    generated_SW_matrix(filename = 'D:/CSU/RPI-MD-/RPI-MD/data/generated_data/NPInter_10412/protein_extracted_seq.fasta',
                        path = 'D:/CSU/RPI-MD-/RPI-MD/data/generated_data/NPInter_10412/')
    generated_SW_matrix(filename='D:/CSU/RPI-MD-/RPI-MD/data/generated_data/RPI2241/protein_extracted_seq.fasta',
